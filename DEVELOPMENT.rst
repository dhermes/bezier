...
.. _Native Libraries: https://bezier.readthedocs.io/en/0.6.1/native-libraries.html
...
.. _functional tests: https://github.com/dhermes/bezier/tree/0.6.1/tests/functional

For example, the following curve-curve intersection is a
functional test case:

.. image:: https://raw.githubusercontent.com/dhermes/bezier/0.6.1/docs/images/curves11_and_26.png
   :align: center

and there is a `Curve-Curve Intersection`_ document which captures many of
the cases in the functional tests.

.. _Curve-Curve Intersection: https://bezier.readthedocs.io/en/0.6.1/curve-curve-intersection.html

A surface-surface intersection functional test case:

.. image:: https://raw.githubusercontent.com/dhermes/bezier/0.6.1/docs/images/surfaces1Q_and_2Q.png
   :align: center

a segment-box functional test case:

.. image:: https://raw.githubusercontent.com/dhermes/bezier/0.6.1/docs/images/test_goes_through_box08.png
   :align: center

and a "locate point on surface" functional test case:

.. image:: https://raw.githubusercontent.com/dhermes/bezier/0.6.1/docs/images/test_surface3_and_point1.png
   :align: center
...
.. _curves.json: https://github.com/dhermes/bezier/blob/0.6.1/tests/functional/curves.json
.. _curve_intersections.json: https://github.com/dhermes/bezier/blob/0.6.1/tests/functional/curve_intersections.json
.. _surfaces.json: https://github.com/dhermes/bezier/blob/0.6.1/tests/functional/surfaces.json
.. _surface_intersections.json: https://github.com/dhermes/bezier/blob/0.6.1/tests/functional/surface_intersections.json
...
.. _pylintrc: https://github.com/dhermes/bezier/blob/0.6.1/pylintrc
...
.. _CircleCI config: https://github.com/dhermes/bezier/blob/0.6.1/.circleci/config.yml
.. _Travis config: https://github.com/dhermes/bezier/blob/0.6.1/.travis.yml
.. _AppVeyor config: https://github.com/dhermes/bezier/blob/0.6.1/.appveyor.yml
.. _python-multi Dockerfile: https://github.com/dhermes/python-multi/blob/master/src/Dockerfile
.. _bezier Dockerfile: https://github.com/dhermes/bezier/blob/0.6.1/scripts/docker/bezier.Dockerfile
...
.. _config: https://github.com/dhermes/bezier/blob/0.6.1/nox.py
