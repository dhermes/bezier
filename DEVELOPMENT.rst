...
.. _Python Binary Extension: https://bezier.readthedocs.io/en/2023.7.27/python/binary-extension.html
...
.. _file: https://github.com/dhermes/bezier/tree/2023.7.27/src/fortran/quadpack.f90
...
.. _functional tests: https://github.com/dhermes/bezier/tree/2023.7.27/tests/functional

For example, the following curve-curve intersection is a
functional test case:

.. image:: https://raw.githubusercontent.com/dhermes/bezier/2023.7.27/docs/images/curves11_and_26.png
   :align: center

and there is a `Curve-Curve Intersection`_ document which captures many of
the cases in the functional tests.

.. _Curve-Curve Intersection: https://bezier.readthedocs.io/en/2023.7.27/algorithms/curve-curve-intersection.html

A triangle-triangle intersection functional test case:

.. image:: https://raw.githubusercontent.com/dhermes/bezier/2023.7.27/docs/images/triangles1Q_and_2Q.png
   :align: center

a segment-box functional test case:

.. image:: https://raw.githubusercontent.com/dhermes/bezier/2023.7.27/docs/images/test_goes_through_box08.png
   :align: center

and a "locate point on triangle" functional test case:

.. image:: https://raw.githubusercontent.com/dhermes/bezier/2023.7.27/docs/images/test_triangle3_and_point1.png
   :align: center
...
.. _curves.json: https://github.com/dhermes/bezier/blob/2023.7.27/tests/functional/curves.json
.. _curve_intersections.json: https://github.com/dhermes/bezier/blob/2023.7.27/tests/functional/curve_intersections.json
.. _triangles.json: https://github.com/dhermes/bezier/blob/2023.7.27/tests/functional/triangles.json
.. _triangle_intersections.json: https://github.com/dhermes/bezier/blob/2023.7.27/tests/functional/triangle_intersections.json
...
.. _pylintrc: https://github.com/dhermes/bezier/blob/2023.7.27/pylintrc
...
.. _Linux config: https://github.com/dhermes/bezier/blob/2023.7.27/.github/workflows/linux.yml
.. _macOS config: https://github.com/dhermes/bezier/blob/2023.7.27/.github/workflows/macos.yml
.. _Windows config: https://github.com/dhermes/bezier/blob/2023.7.27/.github/workflows/windows.yml
.. _python-multi Dockerfile: https://github.com/dhermes/python-multi/blob/master/src/Dockerfile
.. _bezier Dockerfile: https://github.com/dhermes/bezier/blob/2023.7.27/scripts/docker/bezier.Dockerfile
...
.. _config: https://github.com/dhermes/bezier/blob/2023.7.27/noxfile.py
...
- ``PATH``: On Windows, we add the ``bezier/extra-dll`` package directory to
  the path so that the ``bezier.dll`` shared library can be loaded at
