...
src/bezier/_speedup.so: src/bezier/_speedup.pyf src/bezier/types.f90 src/bezier/curve.f90 src/bezier/speedup.f90 .f2py_f2cmap
...
brute-force-pyf: src/bezier/types.f90 src/bezier/curve.f90 src/bezier/speedup.f90 .f2py_f2cmap
	f2py \
	  src/bezier/types.f90 \
	  src/bezier/curve.f90 \
	  src/bezier/speedup.f90 \
