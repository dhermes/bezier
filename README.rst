...
.. image:: https://raw.githubusercontent.com/dhermes/bezier/0.10.0/docs/images/surfaces6Q_and_7Q.png
   :align: center
...
.. image:: https://raw.githubusercontent.com/dhermes/bezier/0.10.0/docs/images/bernstein_basis.png
   :align: center

to define a curve as a linear combination:

.. image:: https://raw.githubusercontent.com/dhermes/bezier/0.10.0/docs/images/bezier_defn.png
   :align: center

This comes from the fact that the weights sum to one:

.. image:: https://raw.githubusercontent.com/dhermes/bezier/0.10.0/docs/images/sum_to_unity.png
   :align: center
...
.. image:: https://raw.githubusercontent.com/dhermes/bezier/0.10.0/docs/images/curves1_and_13.png
   :align: center
...
.. _Curves: https://bezier.readthedocs.io/en/0.10.0/python/reference/bezier.curve.html
.. _Surfaces: https://bezier.readthedocs.io/en/0.10.0/python/reference/bezier.surface.html
.. _package: https://bezier.readthedocs.io/en/0.10.0/python/reference/bezier.html
.. _DEVELOPMENT doc: https://github.com/dhermes/bezier/blob/0.10.0/DEVELOPMENT.rst
.. _the LICENSE: https://github.com/dhermes/bezier/blob/0.10.0/LICENSE

.. |docs| image:: https://readthedocs.org/projects/bezier/badge/?version=0.10.0
   :target: https://bezier.readthedocs.io/en/0.10.0/
   :alt: Documentation Status
.. |circle-build| image:: https://raw.githubusercontent.com/dhermes/bezier/0.10.0/docs/circleci-passing.svg?sanitize=true
   :target: https://circleci.com/gh/dhermes/bezier/1479
   :alt: CircleCI Build
.. |travis-build| image:: https://raw.githubusercontent.com/dhermes/bezier/0.10.0/docs/travis-passing.svg?sanitize=true
   :target: https://travis-ci.org/dhermes/bezier/builds/571656947
   :alt: Travis Build
.. |appveyor-build| image:: https://raw.githubusercontent.com/dhermes/bezier/0.10.0/docs/appveyor-passing.svg?sanitize=true
