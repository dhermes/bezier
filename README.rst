...
.. image:: https://cdn.rawgit.com/dhermes/bezier/0.6.4/docs/images/surfaces6Q_and_7Q.png
   :align: center
...
.. image:: https://cdn.rawgit.com/dhermes/bezier/0.6.4/docs/images/bernstein_basis.png
   :align: center

to define a curve as a linear combination:

.. image:: https://cdn.rawgit.com/dhermes/bezier/0.6.4/docs/images/bezier_defn.png
   :align: center

This comes from the fact that the weights sum to one:

.. image:: https://cdn.rawgit.com/dhermes/bezier/0.6.4/docs/images/sum_to_unity.png
   :align: center
...
.. image:: https://cdn.rawgit.com/dhermes/bezier/0.6.4/docs/images/curves1_and_13.png
   :align: center
...
.. _Curves: https://bezier.readthedocs.io/en/0.6.4/reference/bezier.curve.html
.. _Surfaces: https://bezier.readthedocs.io/en/0.6.4/reference/bezier.surface.html
.. _Package: https://bezier.readthedocs.io/en/0.6.4/reference/bezier.html
.. _DEVELOPMENT doc: https://github.com/dhermes/bezier/blob/0.6.4/DEVELOPMENT.rst
.. _the LICENSE: https://github.com/dhermes/bezier/blob/0.6.4/LICENSE

.. |docs| image:: https://readthedocs.org/projects/bezier/badge/?version=0.6.4
   :target: https://bezier.readthedocs.io/en/0.6.4/
   :alt: Documentation Status
.. |circle-build| image:: https://cdn.rawgit.com/dhermes/bezier/0.6.4/docs/circleci-passing.svg
   :target: https://circleci.com/gh/dhermes/bezier/1184
   :alt: CircleCI Build
.. |travis-build| image:: https://cdn.rawgit.com/dhermes/bezier/0.6.4/docs/travis-passing.svg
   :target: https://travis-ci.org/dhermes/bezier/builds/334046105
   :alt: Travis Build
.. |appveyor-build| image:: https://cdn.rawgit.com/dhermes/bezier/0.6.4/docs/appveyor-passing.svg
   :target: https://ci.appveyor.com/project/dhermes/bezier/build/1.0.855.master
   :alt: AppVeyor CI Build
.. |coverage| image:: https://s3.amazonaws.com/assets.coveralls.io/badges/coveralls_100.svg
   :target: https://coveralls.io/builds/15248555
   :alt: Code Coverage
