...
-  `Adding <https://github.com/dhermes/bezier/commit/dcf40f4c9ed2167e96fc8f4675aeedcc2d811a0b>`__
   ``_verify`` switch to ``Triangle.locate()``
   (`doc <http://bezier.readthedocs.io/en/0.4.0/reference/bezier.surface.html#bezier.surface.Triangle.locate>`__)
   and ``Curve.intersect()``
...
-  Using Horner's method in ``Curve.evaluate_multi()`` and
   ``Triangle.evaluate_barycentric()``, rather than inferior (sometimes
...
-  `Adding <https://github.com/dhermes/bezier/commit/e72ca20f0f4ee0f6399b56805b30fe67a02aa04f>`__
   ...
   ``Triangle.intersect()``
   `method <http://bezier.readthedocs.io/en/0.4.0/reference/bezier.surface.html#bezier.surface.Triangle.intersect>`__
...
-  (**Breaking change**)
   ...
   ``Triangle.plot()``
   (`doc <http://bezier.readthedocs.io/en/0.4.0/reference/bezier.surface.html#bezier.surface.Triangle.plot>`__)
...
-  (**Breaking change**)
   ...
   the ``Triangle.evaluate_multi()``
   `method <http://bezier.readthedocs.io/en/0.3.0/reference/bezier.surface.html#bezier.surface.Triangle.evaluate_multi>`__
   into ``Triangle.evaluate_barycentric_multi()``
   (`doc <http://bezier.readthedocs.io/en/0.4.0/reference/bezier.surface.html#bezier.surface.Triangle.evaluate_barycentric_multi>`__)
   and ``Triangle.evaluate_cartesian_multi()``
   (`doc <http://bezier.readthedocs.io/en/0.4.0/reference/bezier.surface.html#bezier.surface.Triangle.evaluate_cartesian_multi>`__)
-  `Adding <https://github.com/dhermes/bezier/commit/f0fca088ac6f70c39f9f5af457c29e3c82f094b5>`__
   ``__dict__`` helpers on ``Curve``, ``CurvedPolygon`` and ``Triangle``.
