...
.. doctest:: linux-libs
   ...
   bezier.libs/
     libbezier-745c32cf.so.2021.2.12
...
.. testoutput:: linux-readelf-py
   ...
   Dynamic section at offset 0x332000 contains 27 entries:
    ...
    0x0000000000000001 (NEEDED)             Shared library: [libbezier-745c32cf.so.2021.2.12]
...
.. testcode:: linux-readelf-lib
   ...
   invoke_shell("readelf", "-d", "../bezier.libs/libbezier-745c32cf.so.2021.2.12")
   invoke_shell("readelf", "-d", "../bezier.libs/libgfortran-2e0d59d6.so.5.0.0")

.. testoutput:: linux-readelf-lib
   :linux-only:

   $ readelf -d ../bezier.libs/libbezier-745c32cf.so.2021.2.12
   ...
   Dynamic section at offset 0x44dd8 contains 28 entries:
    ...
    0x0000000000000001 (NEEDED)             Shared library: [libc.so.6]
    0x000000000000000e (SONAME)             Library soname: [libbezier-745c32cf.so.2021.2.12]
